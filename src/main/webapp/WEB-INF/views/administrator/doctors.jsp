...
<body>
			...
			<div class="menu">
				...
				<ul class="menu-links">
					...
					<li class="nav-link"><a href="/sistema/appointments"> <i
							class='bx bx-food-menu icon'></i> <span
							class="text nav-text">Citas</span>
					</a></li>
					...
					<li class="nav-link"><a href="/sistema/schedules"> <i
							...
							class="text nav-text">Horarios</span>
					</a></li>
	...
	<section class="home">
		...
		<div class='container'>
			...
			<h4 class='mt-4 text-welcome'>DOCTORES</h4>
			<hr>
			...
			<c:if test="${va == 'errorCmp'}">
				<script type="text/javascript">
					alertErrorCmp();
				</script>
			</c:if>
			<c:if test="${va == 'errorEmail'}">
				<script type="text/javascript">
					alertErrorEmail();
				</script>
			</c:if>
					...
					<form:form action='addDoctor' method="post">
						...
						<div class='mb-3'>
							<select class="form-select" name="specialtyId">
  								<option selected value="null">Selecciona una especialidad</option>
  								<c:forEach items="${specialtys}" var="sp">
  									<option value="${sp.id}">${sp.type}</option>
  								</c:forEach>
							</select>
						</div>
						<span>Cuenta</span>
